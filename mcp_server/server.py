...
def _list_tool_specs() -> list[dict[str, object]]:
    return [
        {
            "name": "search",
            "description": "Search government benefits and assistance programs.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "query": {"type": "string"},
        ...
        {
            "name": "recent_updates",
            "description": "List recently collected benefit articles from DuckDB.",
            "inputSchema": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "top_trends",
            "description": "Show top entity frequencies from recent benefit article matches.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "days": {"type": "integer", "minimum": 1},
